    ...
    <div className={className}>
      ...
      <p className="mt-3 text-sm leading-relaxed text-charcoal-300">
        {signedIn
          ...
          : "New readers sign up with first name, surname, email, and location to open deal links and get the weekly roundup. Already on the list? Sign in with your email to restore access on this device. Unsubscribe pauses emails — your record stays so you can come back anytime."}
      </p>
    </div>
  );
}
